...
const main = async () => {
  ...
  for (const entry of entries) {
    ...
    await Promise.all([
      cp(resolve(renderDirectory, 'instagram-poster-1080x1080.png'), resolve(destination, '01-poster-1080x1080.png')),
      cp(resolve(renderDirectory, 'instagram-details-1080x1080.png'), resolve(destination, '02-details-1080x1080.png')),
  ...
  await writeFile(resolve(outputDirectory, 'README.txt'), 'Each folder contains the two ordered 1080 x 1080 Instagram images and matching caption for one queued movie. This export never posts to Instagram and never changes the queue.\n');
